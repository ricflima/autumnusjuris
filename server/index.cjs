...
app.post('/api/tribunals/consulta', async (req, res) => {
  try {
    ...
    // Em uma implementação real, aqui seria feita a consulta real aos tribunais
    const mockResponse = {
      consulta: {
        ...
        processNumber,
        tribunalType,
        operation: operations[0] || 'consulta_movimentacoes',
        status: 'completed',
      ...
      result: {
        ...
        data: {
          ...
          dataAjuizamento: "2013-04-12",
          valorCausa: 25000.00,
          situacao: "Ativo",
          localizacao: "15ª Vara do Trabalho de São Paulo",
          orgaoJulgador: "15ª Vara do Trabalho",
          ultimaMovimentacao: "2013-05-20",
          partes: [
            {
          ...
          movimentacoes: [
            {
              id: "mov-1",
              data: "2013-04-12",
              titulo: "Petição inicial protocolizada",
              descricao: "Ajuizamento da reclamação trabalhista",
              oficial: true
            },
            {
              id: "mov-2", 
              ...
              descricao: "Distribuição para a 15ª Vara do Trabalho",
              oficial: true
            },
            {
              id: "mov-3",
              data: "2013-05-20", 
              titulo: "Audiência inicial designada",
          ...
          audiencias: [
            {
              ...
              tipo: "Conciliação", 
              situacao: "agendada",
              local: "Sala de Audiências - 15ª Vara do Trabalho"
            }
          ],
          documentos: [],
          recursos: []
      ...
      stats: {
        ...
        tempoMedioResposta: 1500,
        taxaSucesso: 100,
        movimentacoesEncontradas: 3,
